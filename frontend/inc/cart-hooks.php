...
namespace WpCafe_Pro\Core\Modules\Product_Addons_Advanced\Frontend\Inc;
...
class CartHooks {
  ...
  public function init() {
    ...
    public function add_cart_item_data( $cart_item_data, $product_id ) {
		...
		$wpc_addons = \WpCafe_Pro\Core\Modules\Product_Addons_Advanced\Frontend\Inc\Addon_Helper::get_wpc_addon_data( $product_id );
		...
		if ( ! empty( $values['wpc_addons'] ) ) {
			...
			foreach ( $values['wpc_addons'] as $addon ) {
				...
				$price = html_entity_decode(
					strip_tags( wc_price( \WpCafe_Pro\Core\Modules\Product_Addons_Advanced\Frontend\Inc\Addon_Helper::get_wpc_addon_price_for_display( $addon_price, $values['data'] ) ) ),
