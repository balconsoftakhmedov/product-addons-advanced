<?php
namespace WpCafe_Pro\Core\Modules\Product_Addons_Advanced\Admin;
...
class Hooks {
	...
	function labtag_yith_remove_actions() {
		$hooks_instance = \WpCafe_Pro\Core\Modules\Product_Addons\Admin\Hooks::instance();
		...
		remove_action( 'woocommerce_process_product_meta', [ $hooks_instance, 'process_product_meta_data' ], 1 );

		remove_action( 'wp_ajax_add_pao', [ $hooks_instance, 'add_pao_fields' ] );
		remove_action( 'wp_ajax_nopriv_add_pao', [ $hooks_instance, 'add_pao_fields' ] );
	}
	...
	public function panel_tab() {
		?>
				<li class="wpc_pro_pao_tab wpc_pro_pao show_if_simple show_if_variable"><a href="#wpc_pro_pao_content"><span><?php esc_html_e( 'WPCafe Addon Advanced', 'wpcafe-pro' ); ?></span></a></li>
		<?php
		}
